...
async function getPicture() {
  ...
  function displayImg() {
    ...
    imageEl.append(img);
    console.log(img)
    localStorage.setItem("saved-img", img.src);
...
//tamara's code ///
var x= localStorage.key(quoteIndex)
var savedQuote= localStorage.getItem("saved-quotes");
var savedImg =localStorage.getItem("saved-img");
console.log(savedQuote,savedImg);
var quoteIndex = 0;
...
// function savePill() {
//  for (pillIndex=0,pillIndex>0,pillIndex){
